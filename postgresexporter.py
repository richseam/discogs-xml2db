...
class PostgresExporter(object):
    ...
    def execute(self, query, values):
        ...
        try:
            self.cur.execute('SET search_path TO discogs')
    ...
    def storeMaster(self, master):
        ...
        for vid in master.videos:
            self.execute("INSERT INTO masters_videos(uri, title, description, embed, master_id) VALUES(%s,%s,%s,%s,%s);",
                         (vid.uri, vid.title, vid.description, vid.embed, master.id))
